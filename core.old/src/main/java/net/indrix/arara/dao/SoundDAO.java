...
public class SoundDAO extends AbstractDAO {
	...
	private static final String INSERT =
		"INSERT INTO sound (specie_id, user_id, age_id, sex_id, sound, fileSize, location, city_id, post_date, comment) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	private static final String SELECT_BY_ID =
		"SELECT id, specie_id, age_id, sex_id, sound, fileSize, location, city_id, post_date "
			+ "from sound "
			+ "where id = ?";

	private static final String SELECT_BY_SPECIE_ID =
		"SELECT id, user_id, specie_id, age_id, sex_id, sound, fileSize, location, city_id, post_date "
			+ "from sound "
			+ "where specie_id = ?";
	...
	protected void setStatementValues(PreparedStatement stmt, Object object) throws SQLException {
		...
		stmt.setInt(8, sound.getCity().getId());
		stmt.setDate(9, getSQLDate());
		stmt.setString(10, sound.getComment());
	}
