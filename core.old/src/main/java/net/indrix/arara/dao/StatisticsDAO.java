...
public class StatisticsDAO {
    ...
    private static final String SELECT_NUM_FAMILIES = "SELECT distinct specie_family_id FROM photo" ;
    private static final String SELECT_NUM_SPECIES = "SELECT distinct specie_id FROM photo" ;
