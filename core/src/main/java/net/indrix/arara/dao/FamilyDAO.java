...
public class FamilyDAO extends AbstractDAO {
    ...
    public void insert(Family family) throws DatabaseDownException, SQLException {
    ...
    * 
    * @return a <code>List</code> object with <code>Family</code> objects inside.
    * 
    ...
    */
     ...
     * 
     * @param name The name of the <code>Family</code>
     * 
     ...
     * @throws SQLException If some SQL Exception occurs
     */
    public Family retrieve(String name) throws DatabaseDownException, SQLException {
     ...
     * 
     * @param id The id of the <code>Family</code>
     * 
     * @return a <code>Family</code> object 
     * 
     * @throws DatabaseDownException If the database is down
    ...
    /**
     * This method creates a <code>Family</code> object with the data from database
     * 
