...
public class SendEmailtest {
	...
	public static void main(String[] args) {
        ...
        try{
          ...
          sender.sendMessage(true);  // true indicates to emailObject to send the message right now

        }catch(MessageFormatException e){
          System.out.println("exception -> MessageFormatException in sendEmail " + e);
        }catch(AddressException e){
          System.out.println("exception -> AddressException in sendEmail " + e);
        }catch(NoRecipientException e){
          System.out.println("exception -> NoRecipientException in sendEmail " + e);
        }catch(SendFailedException e){
          System.out.println("exception -> SendFailedException in sendEmail " + e);
        }catch(Exception e){
