...
public class Photo {
	...
	/** 
	 * Getter method for the smallImage attribute, as a <code>ImageFile</code> object
	 * 
	...
	/** 
	 * Getter method for the realImage attribute, as a <code>ImageFile</code> object
	 * 
	 ...
	 * 
	 * @param i The new value to the attribute 
	 */
	 ...
	 * 
	 * @param date The new value to the attribute 
	 */
	 ...
	 * 
	 * @param user The new value to the attribute 
	 */
	 ...
	 * 
	 * @param specie The new value to the attribute 
	 */
	 ...
	 * 
	 * @param image The new value to the attribute 
	 */
	 ...
	 * 
	 * @param list The new list of comments 
	 */
	 ...
	 * 
	 * @param age The new value to the attribute
	 */
	 ...
	 * 
	 * @param sex The new value to the attribute
	 */
	...
	public boolean isSoundAvailable() {
		...
		if (specie.isSoundAvailable()) {
			...
			while (it.hasNext() && (!is)) {
				...
				if ((sound.getAge().getId() == ageId) && (sound.getSex().getId() == sexId)) {
                    is = true;
				}
			}
		}
