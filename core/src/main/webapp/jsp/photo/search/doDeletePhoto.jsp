...
<table width="240" >
	<tr bgcolor="#005500"><td><font color="#ffffff">Apagar foto</font></td></tr>
	<tr>
		<td align="left">
	...
	<tr bgcolor="#005500">
	  	<td align="center">
           <a href="<c:url value="/servlet/deletePhoto?photoId=${currentPhoto.id}"/>"><font color="#ffffff">Confirma</font></a>
           <a href="<c:url value="/index.jsp"/>"><font color="#ffffff">Cancela</font></a>
		</td>
	</tr>
</table>