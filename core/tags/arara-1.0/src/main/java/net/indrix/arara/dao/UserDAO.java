...
public class UserDAO extends AbstractDAO {
	...
	public static final String INSERT =
		"INSERT INTO user (name, login, password, email, language, emailOnNewPhoto, emailOnNewIdPhoto, emailOnNewSound, addPhoto, addSound) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
     ...
     * @throws SQLException If some SQL Exception occurs
     */
    public List retrieveForPhotoIdentificationEmail() throws DatabaseDownException, SQLException {
