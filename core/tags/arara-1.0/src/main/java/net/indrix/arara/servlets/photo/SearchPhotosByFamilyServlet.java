	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if ((familyIdStr != null) && (!familyIdStr.equals("")) || (action != null)) {
			...
			PhotoPaginationController controller =
				(PhotoPaginationController) getPaginationController(session, false, PAGINATION_FOR_ALL_FAMILY);
			...
			if (user != null) {
                ...
                loggerActions.info("Anonymous "+ " from IP " + ip + "(" + locale + ") has selected all photos by family.");
			}
