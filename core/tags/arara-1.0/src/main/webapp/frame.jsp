    ...
    <td width="17%" align="left" valign="top" bgcolor="#339966"> 
        ...
        <tr valign="bottom" height="10%">
	    	<td><font size="1" face="Verdana">
              <b><fmt:message key="stat.users"/>: ${f:numberOfUsers()}</b><br>
              <b><fmt:message key="stat.photos"/>       : ${f:numberOfPhotos()}</b><br>
              <b><fmt:message key="family.with.photos"/>  : ${f:numberOfFamilies()}</b><br>
              <b><fmt:message key="species.with.photos"/>  : ${f:numberOfSpecies()}</b><br>
