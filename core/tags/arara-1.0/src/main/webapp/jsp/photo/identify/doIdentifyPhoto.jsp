...
<c:set var="selectedFamilyId" value="${identificationPhotoBean.selectedFamilyId}"/>
<c:set var="selectedSpecieId" value="${identificationPhotoBean.selectedSpecieId}"/>
<c:set var="selectedAgeId" value="${identificationPhotoBean.selectedAgeId}"/>
<c:set var="selectedSexId" value="${identificationPhotoBean.selectedSexId}"/>
...
<form name="identifyPhotoForm" method="post" 
  ...
  <tr> 
    <td align="left" width="8%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="family"/></b></font></td>
    <td align="left" width="22%"> 
        <font size="${fontSize}" face="Verdana">
        <select name="familyId" onChange="familySelected()">
          <c:forEach items="${identificationPhotoBean.familyList}" var="familyBean">
    ...
    <td align="left" width="8%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie"/></b></font></td>
    <td align="left" width="22%"> 
        <font size="${fontSize}" face="Verdana">
        <select name="specieId">
        <c:forEach items="${identificationPhotoBean.specieList}" var="specieBean">
    ...
    <td width="5%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie.age"/></b></font></td>
    <td width="15%"> 
        <font size="${fontSize}" face="Verdana">
        <select name="ageId">
    ...
    <td width="5%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie.sex"/></b></font></td>
    <td width="15%"> 
        <font size="${fontSize}" face="Verdana">
        <select name="sexId">
  ...
  <table width="100%" border="0" cellspacing="2" bgcolor="#A6D2D2">
  <tr>
    <td width="10%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="photo.identify.comment"/></b></font></td>
    <td width="80%">
       <!-- <textarea rows="3 cols="70" name="comment">${identificationPhotoBean.comment}</textarea> -->
	   <input type="text" name="comment" value="${identificationPhotoBean.comment}" size="100" maxlength="256">       
    </td>
    <td width="10%">
       <div align="left">
