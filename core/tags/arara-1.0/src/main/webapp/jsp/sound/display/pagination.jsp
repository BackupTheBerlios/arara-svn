...
<td align="center">
       ...
       %>
	       <a href="<c:url value="${servletToCall}?action=FIRST"/>"><b><fmt:message key="pagination.first"/></b></a>&nbsp;&nbsp;|&nbsp;&nbsp;
	   <%
	   	   }
       %>
       ...
       %>
	       <a href="<c:url value="${servletToCall}?action=NEXT"/>"><b><fmt:message key="pagination.next"/> ></b></a>&nbsp;&nbsp;|&nbsp;&nbsp;
	   <%
	   	   }
       %>
       <% 
          if ((p != null) && (p.hasNext())){
       %>
       <a href="<c:url value="${servletToCall}?action=LAST"/>"><b><fmt:message key="pagination.last"/></b></a>
	   <%
	   	   }
       %>
</td>
