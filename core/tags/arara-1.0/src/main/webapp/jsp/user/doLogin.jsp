...
<input type=hidden name="nextResource" value="${nextResource}">
  
<table width="30%" border="0" cellspacing="2" bgcolor="#A6D2D2" align="center">
  <tr> 
...
<table width="30%" border="0" cellspacing="2" bgcolor="#A6D2D2" align="center">
  <tr> 
    <td width="100%">
       <fmt:message key="user.login.password.msg"/><a href="<c:url value="/jsp/user/forgotPassword.jsp"/>"><fmt:message key="user.login.password.msg.link"/></a>
    </td>
  </tr>
</table>
