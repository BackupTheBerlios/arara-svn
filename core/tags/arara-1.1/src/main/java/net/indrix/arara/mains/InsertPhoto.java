...
public class InsertPhoto {
	...
	public static void main(String[] args) throws IOException,
			DatabaseDownException, SQLException, ImageProcessingException {
		SpecieDAO sDao = new SpecieDAO();
		Specie specie = sDao.retrieve(Integer.parseInt(JOptionPane
				.showInputDialog(null, "Specie Id")));
	...
	private static String createSmallPhoto(Photo photo)
		...
		float r = ((float) photo.getRealImage().getWidth())
				/ photo.getRealImage().getHeight();
		...
		try {
			smallImage = createThumbnail(image, WIDTH_FOR_SMALL_IMAGE,
					hForSmallPhoto);
