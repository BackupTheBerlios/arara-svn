...
public class CommonNameDAO extends AbstractDAO {
	...
	private static final String SELECT_FOR_SPECIE = "SELECT id, name FROM common_name c, specie_has_common_name sc "
	 ...
	 */
	public void insert(CommonName commonName) throws DatabaseDownException,
			SQLException {
	...
	/**
	 * This method retrieves a <code>CommonName</code> object based on its
	 * name
	 * 
	 * @param name
	 *            The name of the <code>CommonName</code>
	 * 
	 ...
	 *             If some SQL Exception occurs
	 */
	public CommonName retrieve(String name) throws DatabaseDownException,
			SQLException {
		CommonName commonName = (CommonName) super.retrieveObject(name,
				SELECT_BY_NAME);
		return commonName;
	}
	 ...
	 * 
	 * @param id
	 *            The id of the <code>CommonName</code>
	 * 
	 * @return a <code>CommonName</code> object
	 * 
	 * @throws DatabaseDownException
	 ...
	 *             If some SQL Exception occurs
	 */
	public CommonName retrieve(int id) throws DatabaseDownException,
			SQLException {
		CommonName commonName = (CommonName) super.retrieveObject(id,
				SELECT_BY_ID);
		return commonName;
	}
	 ...
	 * 
	 * @param specie
	 *            The specie that will get the common names
	 * 
	 * @throws SQLException
	 *             If some SQL Exception occurs
	 */
