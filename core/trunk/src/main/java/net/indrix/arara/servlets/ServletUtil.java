...
public class ServletUtil {
    ...
    /**
     * This method retrives from the request the resource that was requested from the user
     * 
     * @param req The servlet request with the user requests
     * 
    ...
    public static List familyDataAsLabelValueBean(List list) {
        if (familyListInMemory == null){
            ...
            logger.debug("Returning the family data as LabelValueBean without creating objects...");
        }
    ...
    public static List specieDataAsLabelValueBean(List list) {
        if (specieListInMemory == null){
            logger.debug("Creating species data as LabelValueBean for the first time...");
    ...
    public static List commonNameDataAsLabelValueBean(List list) {
        if (commonNamesListInMemory == null){
            ...
            logger.debug("Returning the common names data as LabelValueBean without creating objects...");
        }
