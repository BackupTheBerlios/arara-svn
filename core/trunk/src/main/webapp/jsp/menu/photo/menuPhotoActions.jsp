...
<c:if test="${user.addPhoto == true}">
	<tr>
		<td><font size="2" face="Verdana"> &nbsp;&nbsp;&nbsp;<a
			...
			key="menu.photos.send" /> </a> </font></td>
	</tr>
	<!--  -->
	<tr>
		<td><font size="2" face="Verdana"> &nbsp;&nbsp;&nbsp;<a
			href="<c:url value="/servlet/initUploadPhotosForIdentification"/>"><fmt:message
			key="menu.photos.send.identification" /> </a> </font></td>
	</tr>
</c:if>
<!--  -->
	...
	<c:if test="${identification != true}">
		<tr>
			<td><font size="2" face="Verdana"> &nbsp;&nbsp;&nbsp;<a
				...
				key="menu.photos.comment" /> </a> </font></td>
		</tr>
	</c:if>
</c:if>
