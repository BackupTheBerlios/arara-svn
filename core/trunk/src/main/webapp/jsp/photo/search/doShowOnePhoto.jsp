...
<table border="1" width="${tableW}%">
	...
	<tr>
	  	<td align="left">
	  		<table width="100%" bgcolor="#005500">
	  			<tr><td><font size="${fontSize}" face="Verdana" color="#ffffff"><fmt:message key="show.one.bird.data.title"/></font></td></tr>
	  		</table>
	  		<table width="100%">
	  			<tr>
	  				<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="family"/></b></font></td>
	  				<td><font size="${fontSize}" face="Verdana"><a href="<c:url value="/servlet/searchPhotosByFamily?id=${currentPhoto.specie.family.id}"/>">
	  		...
	  		<table width="100%">
	  			<tr>
	  				<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie"/></b></font></td>
	  				<td><font size="${fontSize}" face="Verdana"><a href="<c:url value="/servlet/searchPhotosBySpecie?id=${currentPhoto.specie.id}"/>">
	  		...
	  		<table width="100%">
	  			<tr>
	  				<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="common.name"/></b></font></td>
	  				<td><font size="${fontSize}" face="Verdana">${currentPhoto.specie.commonNameString}</font></td>
	  			</tr>
	  		</table>

	  		<table width="100%">
	  			<tr>
	  				<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie.age"/></b></font></td>
	  				<td><font size="${fontSize}" face="Verdana">${currentPhoto.age.age}</font></td>
	  			</tr>
	  		</table>

	  		<table width="100%">
	  			<tr>
	  				<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message key="specie.sex"/></b></font></td>
	  				<td><font size="${fontSize}" face="Verdana">${currentPhoto.sex.sex}</font></td>
	  			</tr>
	  		</table>
	...
	<c:if test="${viewMode == 'identificationMode'}">
	<tr>
		<td><c:import url="/jsp/photo/identify/doIdentifyPhoto.jsp"/></td>
	</tr>
	</c:if>
</table>
