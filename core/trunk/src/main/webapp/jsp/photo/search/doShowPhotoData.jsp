...
<table width="100%" bgcolor="#005500">
	<tr>
		<td><font color="#ffffff" size="${fontSize}" face="Verdana"><fmt:message
			key="show.one.photo.data.title" /></font></td>
	</tr>
</table>
<table width="100%">
	<tr>
		<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message
			key="photo.author" /></b></font></td>
		<td><font size="${fontSize}" face="Verdana">${currentPhoto.user.name}
		<a
			href="<c:url value="/servlet/searchPhotosByUser?id=${currentPhoto.user.id}"/>">
...
<table width="100%">
	<tr>
		<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message
			key="comment.title" /></b></font></td>
		<td><textarea rows="5" cols="50" readonly name="comment">${currentPhoto.comment}</textarea>
		</td>
	</tr>
</table>
<table width="100%">
	<tr>
		<td width="20%"><font size="${fontSize}" face="Verdana"><b><fmt:message
			key="show.one.photo.size" /></b></font></td>
