...
<a
	href="<c:url value="/servlet/showOnePhoto?nextPage=/frame.jsp&pageToShow=/jsp/photo/search/doShowOnePhoto.jsp&photoId=${currentPhoto.id}&identification=${identification}"/>">
<img
