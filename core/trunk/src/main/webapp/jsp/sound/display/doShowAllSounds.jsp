...
<table width="100%" border="0" cellspacing="1" >
	<tr valign="top" ><td>
	  <table border="0" width="100%">
	    <tr><td align="center"><b><fmt:message key="all.sounds.title"/></b></td></tr>
	  </table>
		...
		<c:if test="${empty listOfSounds}">
		   <br><h3>Não há sons para a opção selecionada.</h3>
			...
			<tr>
			  	...
			  	<td width="10%"><b><font color="#FFFFFF"><fmt:message key="sound.link.title"/></font></b></td>
			</tr>	
			</table>	
		...
		<c:forEach items="${listOfSounds}" var="sound">
		  ...
		  <table bgcolor="${color}" width="100%">
		  	<tr>
			  	...
			  	<td width="10%" >
			  		<a href="<c:url value="${linkKey}${sound.relativePathAsLink}"/>" target="_blank">
					  	<font size="1" face="Verdana">
					  		<fmt:message key="sound.link.lable"/>
					  	</font>
			  		</a>
			  	</td>
			</tr>
		  	<tr>
			  	...
			  	<td width="86%" colspan="2" align="left"><font size="1" face="Verdana">${sound.comment}</font></td>
			</tr>
		  </table>
